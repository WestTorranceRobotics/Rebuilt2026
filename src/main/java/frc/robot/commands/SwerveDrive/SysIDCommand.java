...
public class SysIDCommand extends Command {
    ...
    private void logDrive(SysIdRoutineLog log) {
        log.motor("fldrive")
                .angularVelocity(modules[0].getDriveWheelVelocity())
                .angularPosition(modules[0].getDriveWheelPosition())
                .voltage(modules[0].getDriveVoltage());
        log.motor("frdrive")
                .angularVelocity(modules[1].getDriveWheelVelocity())
                .angularPosition(modules[1].getDriveWheelPosition())
                .voltage(modules[1].getDriveVoltage());
        log.motor("bldrive")
                .angularVelocity(modules[2].getDriveWheelVelocity())
                .angularPosition(modules[2].getDriveWheelPosition())
                .voltage(modules[2].getDriveVoltage());
        log.motor("brdrive")
                .angularVelocity(modules[3].getDriveWheelVelocity())
                .angularPosition(modules[3].getDriveWheelPosition())
                .voltage(modules[3].getDriveVoltage());
    }

    private void logSteer(SysIdRoutineLog log) {
        log.motor("fldrive")
                .angularVelocity(modules[0].getSteerVelocity())
                .angularPosition(modules[0].getSteerAngle().getMeasure())
                .voltage(modules[0].getSteerVoltage());
        log.motor("frdrive")
                .angularVelocity(modules[1].getSteerVelocity())
                .angularPosition(modules[1].getSteerAngle().getMeasure())
                .voltage(modules[1].getSteerVoltage());
        log.motor("bldrive")
                .angularVelocity(modules[2].getSteerVelocity())
                .angularPosition(modules[2].getSteerAngle().getMeasure())
                .voltage(modules[2].getSteerVoltage());
        log.motor("brdrive")
                .angularVelocity(modules[3].getSteerVelocity())
                .angularPosition(modules[3].getSteerAngle().getMeasure())
                .voltage(modules[3].getSteerVoltage());
    }
        ...
        switch (routineType) {
            ...
            case DRIVE_VELOCITY_QUASISTATIC_REVERSE:
                routine = new SysIdRoutine(
                        new SysIdRoutine.Config((Volts.of(1)).per(Second), Volts.of(3), Seconds.of(5)),
