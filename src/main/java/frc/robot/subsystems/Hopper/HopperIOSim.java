...
public class HopperIOSim extends SubsystemBase implements HopperIO {
    private final SparkMax hopperMotorLeader = new SparkMax(Constants.RealRobotConstants.hopperMotorIDLeader, MotorType.kBrushless);
    private final SparkMax hopperMotorFollower = new SparkMax(Constants.RealRobotConstants.hopperMotorFollowerID, MotorType.kBrushless);
    ...
    public HopperIOSim() {
        ...
        hopperLeaderConfig.smartCurrentLimit(Constants.RealRobotConstants.hopperMotorCurrentLimit);
        ...
        hopperFollowerConfig.smartCurrentLimit(Constants.RealRobotConstants.hopperMotorCurrentLimit);
