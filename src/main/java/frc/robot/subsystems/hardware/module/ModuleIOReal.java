...
public class ModuleIOReal implements ModuleIO {
    ...
    public void setDesiredState(LinearVelocity speed, Rotation2d angle) {
        ...
        setDrivePID(speed.in(MetersPerSecond)
                / robotConstants.wheelCircumference.in(Meters)
                / moduleConstants.driveGearRatio);
    ...
    @Override
    public void tickPID() {
        setSteerVoltage(Volts.of(steerVoltageCoefficient
                * steerPIDController.calculate(getSteerAngle().getRadians())));
    }
